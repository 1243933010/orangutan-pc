      ...
      <div class="context">
        <div class="form">
          ...
          <div class="form-item">
            <el-select v-model="formData.keyword_type" placeholder="资金流水号" style="width: 120px;">
              ...
              <el-option label="来源单号" value="order_no" />
            </el-select>
          </div>
          <div class="form-item"><el-input v-model="formData.keyword" type="number" placeholder="请输入...." /></div>
          <div class="form-item">
            <el-select v-model="formData.method" placeholder="业务类型" style="width: 120px;">
              <el-option label="充值" value="recharge" />
              <el-option label="订单冻结" value="order" />
              <el-option label="余额转化到可提现余额" value="transform" />
              <el-option label="提现" value="withdraw、提现" />
            </el-select>
          </div>
          <div class="form-item">
            <el-select v-model="value" placeholder="业务说明" style="width: 120px;">
          ...
          <div class="form-item">
            <el-date-picker v-model="formData.time" value-format="yyyy-MM-dd" type="daterange" range-separator="至" start-placeholder="开始日期"
        ...
        <div class="table">
          <el-table :data="tableData" style="width: 100%" center>
            ...
            <el-table-column prop="method" label="业务类型">
            </el-table-column>
            <el-table-column prop="money" label="变动金额">
            </el-table-column>
            <el-table-column prop="before_money" label="变动前金额">
            </el-table-column>
            <el-table-column prop="remark" label="备注">
            </el-table-column>
            <el-table-column prop="order_no" label="订单号">
            </el-table-column>
            <el-table-column prop="log_no " label="资金流水号">
            </el-table-column>
            ...
            <el-table-column prop="name" label="资金流水号">
            </el-table-column>
            <el-table-column prop="name" label="来源单号">
            </el-table-column>
            <el-table-column prop="name" label="创建时间">
            </el-table-column>
            <el-table-column prop="name" label="金额">
            </el-table-column>
            <el-table-column prop="name" label="账号金额">
            </el-table-column>
            <el-table-column prop="name" label="冻结金额">
            </el-table-column>
            <el-table-column prop="name" label="收益金额">
            </el-table-column>
            <el-table-column prop="name" label="业务说明">
            </el-table-column> -->
          </el-table>
        </div>
          ...
          <div class="form-item">
            <div class="form-item-left">
              ...
              <div class="form-item-input"><el-select v-model="withdrawalForm.payment_id" placeholder="请选择">
                  <el-option v-for="item in receivingAddressList" :key="item.url" :label="item.url" :value="item.payment_id">
                  </el-option>
                </el-select></div>
            </div>
            <div class="form-item-right">
...
import { fund_list,fund_data,recharge_submit,payment_channel,withdraw_submit } from '@/api/project'
...
export default {
  ...
  methods: {
    ...
    async getList(bool=false) {
      ...
      let res = await fund_list(this.formData)
      if (res.code == 200) {
