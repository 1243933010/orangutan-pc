<template>
    <div class="personal-data-container">
                    ...
                    <el-form ref="basicData" class="basic-data-form" :model="basicData" label-width="94px">
                        ...
                        <div class="right-form">
                            <el-form-item label="用户头像" class="input-box">
                                <div class="avatar">
                                    <img style="width:100%;"
                                        :src="basicData.head_img ? VUE_APP_FILE_URL + basicData.head_img : ''" alt="" />
                                </div>

                                <el-upload class="upload-com" action="" :fileList="[]"
                                    :http-request="(files) => httpRequest1(files)" :before-upload="beforeAvatarUpload"
                                    :limit="1">
                            ...
                            <el-form-item label="账号名称" class="input-box label-border">
                                ...
                                <el-button v-if="!userBool.userName" class="no-bg-btn"
                                    @click="userBool.userName = true">编辑</el-button>
                                <el-button v-if="userBool.userName" @click="setUser('username')"
                                    class="no-bg-btn">修改</el-button>
                            </el-form-item>
                            ...
                            <el-form-item label="邮箱" class="input-box label-border">
                                ...
                                <el-button v-if="!userBool.email" class="no-bg-btn"
                                    @click="userBool.email = true">编辑</el-button>
        ...
        <DirectiveDialog ref="materialsDialogRef" title="编辑资料">
            <MaterialsForm :closeDialog="closeMaterialsDialog" :getDialogData="getMaterialsDialogData"
                :formInfo="basicData">
            </MaterialsForm>
        </DirectiveDialog>
    </div>
