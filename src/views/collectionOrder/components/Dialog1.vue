            ...
            <div class="content">
                <div class="form">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-right">
                            <div class="form-item-right-input"><el-input :disabled="true"
                                    v-model="orderDetail.real_amout" /></div>
                        </div>
                    </div>
                    <div class="form-item">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-item-right">
                            <div class="form-item-right-input"><el-input :disabled="true"
                                    v-model="orderDetail.dealers_name" />
                            </div>
                        </div>
                    </div>
                    <div class="form-item">
                        ...
                        <div class="form-item-right">
                            <div class="form-item-right-input">
                                <el-input :disabled="true" v-model="orderDetail.pay_len" />
                    ...
                    <div class="form-text">
                        ...
                        <span class="label">{{ orderDetail.payment_remark }}</span>
                    </div>
                </div>
...
<script>
import { collection_submit,order_detail } from '@/api/project'
...
export default {
    ...
    methods: {
        ...
        async handleSubmit() {
            ...
            let res = await collection_submit({ payment_id: this.orderDetail.payment_id, order_money: this.form.order_money });
            if (res.code == 200) {
                this.$message.success(res.msg)
                this.getDetail(this.orderDetail.order_id,false)
