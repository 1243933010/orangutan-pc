        ...
        <DirectiveDialog ref="dialog" :title="`订单号${orderDetail.order_no}`"  :refName="refName">
            <div class="content">
                ...
                <div class="form">
                    ...
                    <div class="flex-row" v-if="orderDetail.payment_images">
                    ...
                    <div class="flex-row" v-if="orderDetail.refund_images">
                    ...
                    <div class="flex-row" v-if="orderDetail.dealer_refund_images">
                        <div class="form-items" style="width:50%;">
                            <div class="form-item-title" style="width:200px;">卡商退款证明</div>
                            <div class="form-item-title form-item-see" @click="seeImg(orderDetail.dealer_refund_images)">查看附件
                            </div>
                        </div>
                    </div>
                </div>
